...
_wajig()
{
    ...
    if [ "$COMP_CWORD" -ge "2" ]; then
        ...
        build-depend changelog clean contents daily-upgrade dependents \ 
        describe describe-new detail detail-new dist-upgrade docs download \ 
        download-file editsources extract find-file find-pkg fix-configure \ 
        fix-install fix-missing force help hold init info install install-file \ 
        installr installrs installs integrity large last-update list \ 
